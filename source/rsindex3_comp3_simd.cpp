...
int RSIndexComp3::build(const std::vector<std::vector<seqan3::dna4>> &input)
{
    ...
    // auto view2 = srindex::views::xor_minimiser_and_window2({.minimiser_size = m2, .window_size = k, .seed=seed2});
    auto view2 = srindex::views::xor_minimiser_and_positions2({.minimiser_size = m2, .window_size = k, .seed=seed2});
    ...
    // auto view3 = srindex::views::xor_minimiser_and_window2({.minimiser_size = m3, .window_size = k, .seed=seed3});
    auto view3 = srindex::views::xor_minimiser_and_positions2({.minimiser_size = m3, .window_size = k, .seed=seed3});
...
std::vector<uint64_t> RSIndexComp3::rand_text_kmers(const uint64_t n) {
...
uint64_t RSIndexComp3::lookup(const std::vector<uint64_t> &kmers, bool verbose)
{
...
{
    auto view = srindex::views::three_minimisers_and_window_hash2({.minimiser_size1 = m1, .minimiser_size2 = m2, .minimiser_size3 = m3, .window_size = k, .seed1=seed1, .seed2=seed2, .seed3=seed3});
