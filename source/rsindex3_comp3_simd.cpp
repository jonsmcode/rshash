...
uint64_t RSIndexComp3::lookup(const std::vector<uint64_t> &kmers)
{
    ...
    // std::chrono::high_resolution_clock::time_point t0, t1, t2, t3, t4, t5 = std::chrono::high_resolution_clock::now();
    // double t0_ = 0.0;
    // double t1_ = 0.0;
    // double t2_ = 0.0;
    // double t3_ = 0.0;
