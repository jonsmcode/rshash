  ...
  do
    ...
    if [[ "$BASENAME" == *"bacterial"* || "$BASENAME" == *"human"* || "$BASENAME" == *"cod"* || "$BASENAME" == *"kestrel"* ]]; then
      if [ "$k" -le 32 ]; then
        ...
        # minimisers=( $((m)) $((m+1)) $((m + 3))  $((m)) $((m + 2)) $((m + 3))  $((m)) $((m + 2)) $((m + 4))  $((m + 1)) $((m + 2)) $((m + 3))  $((m + 1)) $((m + 3)) $((m + 4))  $((m + 2)) $((m + 3)) $((m + 4))  $((m + 2)) $((m + 4)) $((m + 4)) )
        minimisers=( $((m + 1)) $((m + 2)) $((m + 3))  $((m + 1)) $((m + 3)) $((m + 4))  $((m + 2)) $((m + 3)) $((m + 4))  $((m + 2)) $((m + 4)) $((m + 4)) )
        # thresholds=( 16 32 64  16 64 256  32 128 512  64 128 256 )
        thresholds=( 8 16 32  8 32 128  8 64 512 )
        spans=( $((k - m + 1)) )
          ...
          for ((j=0; j<${#thresholds[@]}; j+=3)); do
            for span in "${spans[@]}"; do
              ...
              for query in "${queries[@]}"; do
                  ...
                  echo $query >> $LOG
                  echo $query
                  /usr/bin/time -v -o time2.txt $PROGRAM query -d "${BASENAME}.complookup3.dict" -q $query > prog_out2.txt 2>&1
